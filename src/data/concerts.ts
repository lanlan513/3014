...
const makeSetlist = (songs: { title: string; special?: boolean; note?: string; albumId?: string }[]): SetlistItem[] => {
...
export const concerts: Concert[] = [
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '孤独患者' },
      { title: '想哭' },
      { title: '人啊人', special: true, note: '新歌首唱' },
      { title: '恐惧' },
      { title: '梦的可能' },
      { title: '完' },
      { title: '四季圈' },
      ...
      { title: '舞台哈夏' },
      { title: '好歌献给你' },
      { title: '夜空中最亮的星', special: true, note: '翻唱' },
      { title: 'Hallelujah', special: true, note: '翻唱' },
      { title: '明年今日' },
      { title: '任我行' },
      { title: '夕阳无限好' },
      { title: 'K歌之王' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '与我常在' },
      { title: '天下无双' },
      { title: '春光乍泄', special: true, note: '翻唱黄耀明' },
      { title: '坏习惯', special: true, note: '与谢霆锋合唱' },
      { title: '因为爱情', special: true, note: '与杨千嬅合唱' },
      { title: '兄妹' },
      { title: '我们都寂寞' },
      { title: '淘汰' },
      { title: '然后怎样' },
      ...
      { title: '好歌献给你' },
      { title: '绵绵' },
      { title: '冷雨', special: true, note: '翻唱' },
      { title: '非走不可', special: true, note: '翻唱谢霆锋' },
      { title: '明年今日' },
      { title: '任我行' },
      { title: '夕阳无限好' },
      { title: 'K歌之王' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '天下无双' },
      { title: '十年' },
      { title: '同桌的你', special: true, note: '与老狼合唱' },
      { title: '淘汰' },
      { title: '兄妹' },
      { title: '我们都寂寞' },
      { title: '路一直都在' },
      { title: '孤勇者', special: true, note: '特别演唱' },
      { title: '孤独患者' },
      { title: '人啊人' },
      { title: '恐惧' },
      { title: '梦的可能' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '谢谢侬' },
      { title: '类月球' },
      { title: '任我行', special: true, note: '新歌首唱' },
      { title: 'K歌之王' },
    ]),
  },
  {
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '好歌献给你' },
      { title: '落花流水' },
      { title: '囍帖街', special: true, note: '翻唱谢安琪' },
      { title: '七百年后' },
      { title: '约定', special: true, note: '翻唱王菲' },
      { title: '寂寞夜晚', special: true, note: '翻唱张国荣' },
      { title: '浮夸' },
      { title: '喉舌' },
      { title: 'PG家长指引', special: true, note: '翻唱梁汉文' },
      { title: '那一夜有没有说' },
      { title: '反高潮' },
      { title: '一丝不挂' },
      { title: '单车' },
      { title: '和莎莫的500天', special: true, note: '翻唱' },
      { title: '陀飞轮' },
      { title: '夕阳无限好' },
      { title: '我的快乐时代' },
      { title: '歌．颂' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '寂寞夜晚' },
      { title: '浮夸' },
      { title: '爱情陷阱', special: true, note: '与谭咏麟合唱' },
      { title: '每天爱你多一些', special: true, note: '与张学友合唱' },
      { title: '吻别', special: true, note: '翻唱张学友' },
      { title: '陀飞轮' },
      { title: '喉舌' },
      { title: 'PG家长指引' },
      { title: '那一夜有没有说' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '怪物' },
      { title: '心里有鬼' },
      { title: '两名男子街头相遇', special: true, note: '翻唱' },
      { title: '不良嗜好' },
      { title: '怕死' },
      { title: '三个人的探戈' },
      { title: '孤独探戈' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '2001太空漫游' },
      { title: '打得火热' },
      { title: 'K房房客', special: true, note: '翻唱' },
      { title: '夕阳无限好' },
      { title: 'K歌之王' },
      { title: '葡萄成熟时' },
      { title: '明年今日' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '不能再等待' },
      { title: '不如不见' },
      { title: '一滴眼泪', special: true, note: '国语歌曲' },
      { title: '浮夸' },
      { title: '富士山下' },
      { title: '裙下之臣' },
      { title: '陀飞轮', special: true, note: '提前演唱' },
      { title: 'K歌之王' },
      { title: '夕阳无限好' },
      { title: '人车志' },
      { title: '玛利奥派对' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '零下几分钟' },
      { title: '披风' },
      { title: '你给我听好', special: true, note: '歌迷点歌' },
      { title: '淘汰' },
      { title: '富士山下' },
      { title: '十年' },
      { title: '不如这样' },
      ...
      { title: '谢谢侬' },
      { title: '孤独患者' },
      { title: '可一可再', special: true, note: '新歌' },
      { title: '与我常在' },
      { title: 'K歌之王' },
    ]),
  },
  {
    ...
    setlist: makeSetlist([
      { title: 'Se Vuol Ballare', special: true, note: '意大利歌剧选段' },
      { title: '打回原形' },
      { title: 'K歌之王' },
      { title: '谎言' },
      { title: '真相' },
      ...
      { title: '孤单探戈' },
      { title: '春光乍泄' },
      { title: '新的世界', special: true, note: '迪士尼歌曲' },
      { title: '不再让你孤单', special: true, note: '翻唱陈升' },
      { title: '我有我爱你' },
      { title: '谢谢侬' },
      { title: '他一个人' },
      { title: '你的背包' },
      ...
      { title: '与我常在' },
      { title: '天下无双' },
      { title: '永远都天明', special: true, note: '翻唱' },
    ]),
  },
  {
    ...
    setlist: makeSetlist([
      { title: '现场人生', special: true, note: 'Opening' },
      { title: '第五个现代化' },
      { title: '我什么都没有' },
      { title: '与我常在' },
      { title: '今天等我来' },
      { title: '时代曲' },
      { title: '天下无双', special: true, note: '全场大合唱' },
      { title: '抱拥这分钟' },
      { title: '今日' },
      { title: '黑夜不再来' },
      { title: '爱情，幼稚！' },
      ...
      { title: '美丽有罪' },
      { title: '我的世界末日' },
      { title: '月光曲', special: true, note: '与梅艳芳合唱' },
      { title: '心债', special: true, note: '翻唱梅艳芳' },
      { title: '飘飘飘飘' },
      { title: '我的快乐时代' },
      { title: '与我常在' },
    ]),
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '与我常在' },
      { title: '天下无双' },
      { title: 'K歌之王', special: true, note: '与容祖儿合唱' },
      { title: '明年今日' },
      { title: '富士山下' },
      { title: '任我行' },
      { title: '夕阳无限好' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '淘汰' },
      { title: '兄妹' },
      { title: '成都', special: true, note: '翻唱赵雷' },
      { title: '好久不见' },
      { title: '爱情转移' },
      { title: '路一直都在' },
      { title: '孤独患者' },
  ...
  },
  {
    ...
    setlist: makeSetlist([
      ...
      { title: '与我常在' },
      { title: '天下无双' },
      { title: '淘汰', special: true, note: '与周杰伦合唱' },
      { title: '十年' },
      { title: '兄妹' },
      { title: '我们都寂寞' },
      { title: '好久不见' },
...
export const getConcertsByTourId = (tourId: string): Concert[] => {
  return concerts.filter((c) => c.tourId === tourId).sort((a, b) => a.date.localeCompare(b.date));
};

export const getConcertsByCityId = (cityId: string): Concert[] => {
...
export const getConcertsByYear = (year: number): Concert[] => {
